    ...
    try {
        ...
        switch (reportId) {
            ...
            case 'forecast': // Forecast
                ...
                const opportunities = await atlasRuntime.entities.Opportunity.list();
            ...
            case 'sources': // Lead Sources
                // Export Leads
                const leads = await atlasRuntime.entities.Lead.list();
            ...
            case 'activity': // Activity Report
                // Export Activities
                const activities = await atlasRuntime.entities.Activity.list();
            ...
            default:
                ...
                const defaultOpps = await atlasRuntime.entities.Opportunity.list();

export default {
  id: "phase11-ai-security-foundation",
  expectedHead: "6e66de294aab883806f36b0e7c7f8583a3ddb05c",
  requireClean: false,
  files: [
    {
      path: "functions/src/atlasAiGateway.ts",
      create: true,
...
`,
    ...
    {
      path: "tests/atlas.ai.gateway.test.js",
      create: true,
      ...
      operations: [
        {
          ...
          content:
            "export {executeAtlasAiCallable} from " +
            "\"./atlasAiGateway.js\";\n" +
